...
public:
  ...
  virtual void getall(std::istream & fin);
  virtual void writeall(std::ostream & fout) const;
...
public:
  ...
  virtual void getall(std::istream & fin) {abstr_emp::getall(fin);}
  virtual void writeall(std::ostream & fout) const;
};
